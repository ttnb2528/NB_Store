...
import { useGetFilteredProductsQuery } from "../Redux/api/product.api.js";
import { useFetchCategoriesQuery } from "../Redux/api/category.api.js";
  ...
  return (
    <>
      <div className="container mx-auto ">
        <div className="flex mf:flex-row text-white">
          <div className="bg-[#151515] p-3 mt-2 mb-2">
            ...
            <h2 className="h4 text-center py-2 bg-black rounded-full b-2">
              Filter by Brands
            </h2>
